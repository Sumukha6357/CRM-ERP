...
# ==============================
# Project Docker Operations (CRM-ERP)
# ==============================
...
.PHONY: dev prod local up build down stop start restart logs logs-dev logs-prod logs-local ps exec exec-web exec-api exec-db rebuild rebuild-no-cache reset clean clean-all images pull push status top stats
